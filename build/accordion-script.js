...
const AccordionMaker = function (accordionContainer, i) {
  ...
  this.init = function (isOpen) {
    ...
    button.classList.add('mrw-accordion__button'); // ARIA and Event for Button

    button.setAttribute('aria-expanded', isOpen);
    button.addEventListener('click', e => toggleAccordion(e.currentTarget.getAttribute('aria-controls').replace('-content', '')), false); // ARIA for body

    body.setAttribute('aria-hidden', !isOpen); // Class to distinguish JS-enabled accordions
