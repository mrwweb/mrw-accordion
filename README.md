...
> [!CAUTION]
> This plugin is no longer supported. Use the core Accordion block introduced in WordPress 6.9. v0.8.0 of the MRW Accordion Block adds the ability to convert any `mrw/accordion` block to `core/accordion` using the block transform menu in the block toolbar.
...
### 0.8.0 (November 14, 2025)

- ⚠ LAST UPDATE EVER. DO NOT USE THIS BLOCK! ⚠
- Add ability to transform block to core Accordion
- Add deprecated block notice in readme
